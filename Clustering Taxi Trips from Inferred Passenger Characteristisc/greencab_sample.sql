(SELECT
  ...
  -- Expl. variables
  MOD(EXTRACT(HOUR FROM g14.pickup_datetime)+2, 6) AS time_of_day,
...
(SELECT
  ...
  -- Expl. variables
  MOD(EXTRACT(HOUR FROM g15.pickup_datetime)+2, 6) AS time_of_day,
...
(SELECT
  ...
  -- Expl. variables
  MOD(EXTRACT(HOUR FROM g16.pickup_datetime)+2, 6) AS time_of_day,
...
(SELECT
  ...
  -- Expl. variables
  MOD(EXTRACT(HOUR FROM g17.pickup_datetime)+2, 6) AS time_of_day,
